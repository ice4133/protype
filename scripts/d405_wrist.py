...
def generate_launch_description():
    ...
    # Low-latency settings for wrist cameras
    d405_configs = [
        {
            'camera_name': 'cam_left_wrist',
            'serial_no': '_230322275424',
            ...
            # 'json_file_path': f'{config_dir}/d405.json',
            ...
            # Limit exposure for lower latency (microseconds)
